    ...
    <main className="mt-20 lg:mt-24">
      ...
      >
        <div className="text-center flex items-center justify-center h-full w-full bg-gray-900 bg-opacity-50">
          <h2 className="text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)] text-2xl font-poppins font-bold md:text-6xl">
            Contact Us
          </h2>
        </div>
      </section>
      <section className="bg-siteColor py-10 lg:py-4">{children}</section>
